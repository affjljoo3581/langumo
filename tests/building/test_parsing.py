...
def test_formatted_file_parsing():
    with AuxiliaryFileManager('tmp') as afm:
        ...
        with (ParseRawFile(simple_parser(), num_workers=2)
              .build(afm, corpus)
              .open('r')) as fp:
            assert ({s.strip() for s in fp} == {
                     ...
                     'editing system.',
                     'It is the largest and most popular general reference '
                     'work on the World Wide Web.',
                     'It is also one of the 15 most popular websites ranked '
                     'by Alexa, as of August 2020.',
                     'It features exclusively free content and no commercial '
                     'ads.',
                     'It is hosted by the Wikimedia Foundation, a non-profit '
                     'organization funded primarily through donations.',
                     'Wikipedia was launched on January 15, 2001, and was '
                     'created by Jimmy Wales and Larry Sanger.',
                     'Sanger coined its name as a portmanteau of the terms '
                     '"wiki" and "encyclopedia".',
                     'Initially an English-language encyclopedia, versions of '
                     'Wikipedia in other languages were quickly developed.',
                     'With 6.1 million articles, the English Wikipedia is the '
                     'largest of the more than 300 Wikipedia encyclopedias.',
                     'Overall, Wikipedia comprises more than 54 million '
                     'articles attracting 1.5 billion unique visitors per '
                     'month.',
                     ...
                     'issues.',
                     'The following year, Time stated that the open-door '
                     'policy of allowing anyone to edit had made Wikipedia '
                     'the biggest and possibly the best encyclopedia in the '
                     'world, and was a testament to the vision of Jimmy '
                     'Wales.',
                     ...
                     'truth, and some falsehoods".',
                     'Wikipedia has also been criticized for gender bias, '
                     'particularly on its English-language version, where the '
                     'dominant majority of editors are male.',
                     'However, edit-a-thons have been held to encourage '
                     'female editors and increase the coverage of women\'s '
                     'topics.',
                     'Facebook announced that by 2017 it would help readers '
                     'detect fake news by suggesting links to related '
                     'Wikipedia articles.',
